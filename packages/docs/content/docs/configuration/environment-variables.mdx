...
| `MAX_JSON_BODY_SIZE`              | Max Json Body Size              | size       | `1048576`                                    | Largest JSON request body the API accepts, which bounds saved configurations and uploaded templates. Raise it if large templates are refused with a 413. _(restart required)_                                                                                                          |
